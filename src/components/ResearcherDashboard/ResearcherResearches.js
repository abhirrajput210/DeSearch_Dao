  ...
  return (
    <div>
      ...
      <div className="add-research-container">
        <button className="add-research-button rounded-pill" onClick={handleAddResearch}>
          <span className="add-research-icon"><FontAwesomeIcon icon={faPlus} className="icons" /></span> Add Researches
        </button>
      </div>
        ...
        {researchesData.map((research) => (
          <div className='rr-card-container' key={research.id}>
            <div className='rr-image-container'>
              <img src={research.img} alt='img' style={{ width: '380px', height: '200px', objectFit: 'cover' }} />
            </div>
